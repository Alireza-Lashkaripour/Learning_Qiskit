...
from qiskit_nature.second_q.formats.fcidump.fcidump import FCIDump
...
def build_circuit_from_mps(mps_data, target_dim=2):
    ...
    # Add these print statements to display the quantum circuit
    print("Quantum Circuit Description:")
    print(qc)
    print("\nQuantum Circuit Depth:", qc.depth())
    print("Number of Gates:", qc.count_ops())
